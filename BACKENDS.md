...
- `transcript.done` event → fires at stream end; empty text is ignored, non-empty text ends the turn like a `speech_final`; includes detected `language` field
