/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6f7663bf5584511fbf4ecd565361943e)
// Runtime types generated with workerd@1.20251001.0 2025-09-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Transcriptionator" | "TranscriptionSession";
	}
	interface Env {
		...
		USE_TRANSCRIPTION_SESSION_DO: string;
		// Bindings
		TRANSCRIPTIONATOR: DurableObjectNamespace<import("./src/index").Transcriptionator>;
		TRANSCRIPTION_SESSION: DurableObjectNamespace<import("./src/index").TranscriptionSession>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FORCE_COMMIT_TIMEOUT" | "USE_TRANSCRIPTION_SESSION_DO">> {}
}
